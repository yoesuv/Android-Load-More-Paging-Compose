package com.yoesuv.infinitescroll.core.paging

import androidx.paging.PagingSource
import androidx.paging.PagingState
import com.yoesuv.infinitescroll.core.models.PostModel
import com.yoesuv.infinitescroll.core.networks.NetworkResult
...
class PostPagingSource(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, PostModel> {
        ...
        return try {
            ...
            val response =
                apiService.getPosts(page, params.loadSize).first {
